      ...
      <div className="flex items-center h-screen overflow-hidden">
          <div className="mt-72 max-w-3xl">
            ...
            <div className="overflow-auto flex flex-col gap-5 max-h-screen pb-72">
              ...
              <img width="80%" className="mx-auto" src="/images/steamo/overview.png" />
              <p className="mx-auto">This is what this page looks like</p>
              <div className="flex flex-row items-center">
                <img width="30%" src="/images/steamo/appid.png" className="mr-10 ml-10" />
                <p>First you need to type app id<br/>easiest way is to go to store page and check Url<br/></p>
              </div>
              <img width="80%" className="mx-auto" src="/images/steamo/enter.gif" />
